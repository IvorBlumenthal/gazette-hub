          ...
          try {
                  const resp = await fetch('https://api.anthropic.com/v1/messages', {
                            ...
                            body: JSON.stringify({
                                        ...
                                        max_tokens: 2000,
                                        system: 'You are a South African government gazette analyst. You use web search to find real, verified gazette notices. You return only valid JSON arrays as instructed. You never invent notices. If nothing is found, return [].',
                  ...
                  if (!resp.ok) {
                            ...
                            return { statusCode: 502, body: JSON.stringify({ error: err.error?.message || 'Anthropic API error' }) };
                  }
                  ...
                  return { statusCode: 500, body: JSON.stringify({ error: 'Internal error: ' + e.message }) };
          }
    }
